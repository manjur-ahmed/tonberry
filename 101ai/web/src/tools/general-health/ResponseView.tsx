...
// A single turn's reply — what tool-config.ts's GENERAL_HEALTH_SCHEMA
...
function GeneralHealthResponse({ content, toolSlug, chatId, messageId, readOnly, onSaveStatusChange, onCopyTextChange }: ResponseViewProps) {
...
export default GeneralHealthResponse
