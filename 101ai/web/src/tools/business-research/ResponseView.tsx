...
// A single turn's reply — what tool-config.ts's BUSINESS_RESEARCH_SCHEMA
...
function BusinessResearchResponse({ content, toolSlug, chatId, messageId, readOnly, onSaveStatusChange, onCopyTextChange }: ResponseViewProps) {
  ...
  // Every research turn is worth saving, so it happens automatically
...
export default BusinessResearchResponse
