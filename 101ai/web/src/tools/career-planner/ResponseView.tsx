...
// A single turn's reply — what tool-config.ts's CAREER_PLANNER_SCHEMA
...
function CareerPlannerResponse({ content, toolSlug, chatId, messageId, readOnly, onSaveStatusChange, onCopyTextChange }: ResponseViewProps) {
...
export default CareerPlannerResponse
