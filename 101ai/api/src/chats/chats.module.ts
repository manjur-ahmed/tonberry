...
// likewise, purely so ChatsService can hand off to its real-data pipeline
// instead of OpenAiService.generateReply (see steps-planner handling in
// ChatsService). News was a live-search tool built this way too
// (GDELT-backed) but was reverted — News is a plain generateReply tool
// again like everything else, see project memory for why.
@Module({
  imports: [
